...
<div id="postbox" class="well" style="margin-top:50px;">
	<form id="new_post" name="new_post" method="post" action="<?php bloginfo( 'url' ); ?>/" >
		...
		<?php wp_nonce_field( 'new-post' ); ?>
			<div class="inputarea">
			<div>
				<div style="margin-bottom: 10px;" id="wysihtml5-toolbar" style="display: none;">

					<div class='btn-group'>
					
						<a class='btn' data-wysihtml5-command='bold' title='CTRL+B'><i class='icon-bold'></i><strong>&nbsp;Bold</strong></a>
					    <a class='btn' data-wysihtml5-command='italic' title='CTRL+I'><i class='icon-italic'></i><em>&nbsp; Italics</em></a>
	    				<a class='btn' data-wysihtml5-command='insertUnorderedList'><i class='icon-list'> </i>&nbsp;List</a>
     				    <a class='btn' data-wysihtml5-command='insertOrderedList'><i class='icon-th-list'></i>&nbsp;Numbered List</a>
     				    <a class='btn' data-wysihtml5-command='createLink'><i class='icon-bookmark'></i>&nbsp;Link</a>
					</div>



  <div class="alert alert-info" data-wysihtml5-dialog="createLink" style="display: none;">
    <label>
      Link:
